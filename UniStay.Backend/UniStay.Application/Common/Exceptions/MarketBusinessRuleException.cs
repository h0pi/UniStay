...
/// </summary>
public sealed class UniStayBusinessRuleException : Exception
{
    public string Code { get; }

    public UniStayBusinessRuleException(string code, string message)
        : base(message)
    {
        Code = code;
    }

    public UniStayBusinessRuleException(string code, string message, Exception? innerException)
